...
namespace Mapbox.Unity.Map
{
    ...
    public class AbstractMap : MonoBehaviour, IMap
    {
        ...
        protected virtual void InitializeMap(MapOptions options)
        {
            ...
            Debug.Log(_centerLatitudeLongitude.x + "   " + _centerLatitudeLongitude.y);
            _centerLatitudeLongitude = new Vector2d((double)PlayerPrefs.GetFloat("lat"), (double)PlayerPrefs.GetFloat("longi"));
            Debug.Log(_centerLatitudeLongitude.x + "   " + _centerLatitudeLongitude.y);
